...
public class OrderEntity implements Serializable {
    ...
    public OrderEntity(String uuid, Double bill, CouponEntity couponEntity, Double discount, Date orderDate, PaymentEntity paymentEntity, com.upgrad.FoodOrderingApp.service.entity.CustomerEntity customerEntity, AddressEntity addressEntity, RestaurantEntity restaurantEntity) {
        this.uuid = uuid;
        this.bill = bill;
